    ...
    return (
        <div className="p-3 bg-sky-50 rounded-lg border border-sky-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2"><Label className="text-sm font-medium">Pencahayaan</Label><Input placeholder="senja yang dramatis, menyoroti siluet" value={lighting} onChange={(e) => setLighting(e.target.value)} /></div>
                <div className="space-y-2"><Label className="text-sm font-medium">Gaya Video/Art Style</Label><Input placeholder="sinematik ala film indie" value={artStyle} onChange={(e) => setArtStyle(e.target.value)} /></div>
            </div>
        </div>
    );
};
